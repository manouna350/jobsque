...
class ApplyJobStepper extends StatefulWidget {
  const ApplyJobStepper({super.key});
...
class _ApplyJobStepperState extends State<ApplyJobStepper> {
  GlobalKey<FormState> stepperForm = GlobalKey();
  int currentStep = 0;
  int selectedValue = 1;
                        ...
                        controlsBuilder: (context, onStepContinue) =>
                            defaultButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (isLastStep) {
                                    stepperForm.currentState!.validate();
                                    setState(() {
                                      isCompleted = true;
                                    });
                                  } else {
